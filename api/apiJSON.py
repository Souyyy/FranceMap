...
def trajet(var1,var2,var3,vue=[],distances={},precede={}):
    ...
    if var2 == var3:
        ...
        for index in range(0,len(path)):
            affiche = path[index] + affiche
            villetrouve[path[index]] = index

        Dict = {}
        Dict['VilleProche'] = {key: value for key, value in zip(reversed(villetrouve.keys()), villetrouve.values())}
        Dict['Km'] = {str(distances[var3])}
        print(Dict)
